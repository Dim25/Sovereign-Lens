...
const SHOTS = [
  { file: 't0-commitment.png', stop: 'Set as_of to 2025-05-28' },
  { file: 't1-resolution.png', advance: true },
  { file: 'evidence-drawer.png', advance: true, cite: 'campus_capacity_reported_operational' },
]
