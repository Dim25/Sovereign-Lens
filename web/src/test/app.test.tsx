...
describe('product navigation', () => {
  it('opens with a narrative homepage and links into the executive brief', async () => {
    ...
    expect(screen.getByRole('heading', { name: /see the writes.*shape the horizon/i })).toBeInTheDocument()
    expect(screen.getByRole('button', { name: /strategy atlas/i })).toBeInTheDocument()
