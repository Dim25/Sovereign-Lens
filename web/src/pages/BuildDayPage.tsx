...
const stages = [
  ...
  ['03', 'Model parallax', 'Codex · Qwen 3.8 Max · GLM 5.2 · DeepSeek V4 Pro', 'Held evidence and prompt constant, preserved disagreement, and stored provider, model, region, time, assumptions, missing evidence, and falsifiers.'],
  ...
  return <div className="build-day">
    ...
    <main className="build-day__main">
      ...
      <section className="build-day__video">
        <div className="section-index">02 · Scenario film · proposed 30s cut</div>
