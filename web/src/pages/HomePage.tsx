      ...
      <main className="home">
        ...
        <section className="live-case">
          ...
          <div className="model-parallax">
            <div className="model-parallax__head">
              ...
              <span>Prototype perspectives · Qwen, GLM + DeepSeek authenticated runs pending</span>
            </div>
        ...
        <section className="interface-proof">
          ...
          <div className="interface-proof__intro">
            ...
            <div>
              <p>The interface preserves the graph, competing interpretations, prediction ledger, later outcome, and source-level provenance in one auditable temporal record.</p>
              <div className="interface-proof__links">
                <button onClick={() => navigate('/cases')}>Open strategy atlas →</button>
                <button onClick={() => navigate('/horizon')}>Program a Horizon →</button>
              </div>
            </div>
          </div>
          <div className="interface-montage">
            ...
            <div className="interface-montage__stack">
              ...
              <button className="interface-shot" onClick={() => navigate('/cases/uae-us-ai-infrastructure')}>
                ...
                <span><b>03</b> Provenance · every visible claim resolves to its source</span>
              </button>
            </div>
          </div>
