...
def stash_memory(task: ReassessmentTask) -> dict:
    ...
    return {
        ...
        "author": {"kind": "agent", "id": "sovereign-lens-researcher"},
        "review": {"status": "unreviewed", "reviewer": None, "reviewed_at": None},
        "access": {"classification": "internal", "allowed_roles": ["researcher", "reviewer"]},
        "retention": {"policy": "review_at_horizon", "review_at": task.due_at},
        "status": "open",
